...
def build_live(
    ...
    **kwargs
    ...
    model = model_class.from_pretrained(llm_pretrained, config=config_class.from_pretrained(llm_pretrained, quantization_config=quantization_config, torch_dtype=torch.float16, **kwargs), torch_dtype=torch_dtype, quantization_config=quantization_config)
